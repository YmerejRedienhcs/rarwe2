// tests/helpers/asserts.js
import { registerHelper } from '@ember/test';

function assertCurrentURL(app, assert, text, errorMessage) {
  assert.equal (currentURL(), text, errorMessage);
}
...
registerHelper('assertCurrentURL', assertCurrentURL);
